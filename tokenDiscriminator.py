...
from utilities import extract_packet_sizes, extract_packet_size_ranges, token_frequency_features_and_labels, sequence_features, generate_traffic_rate_features, splitAllFeatures
import warnings
...
discriminator.fit([X_train, tr_train, seq_train], class_train, epochs=7000, batch_size=256, verbose=1)
