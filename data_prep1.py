...
from pcaputilities import convert_range, convert_sig_sequences_to_ranges, map_all_signatures, chunk_and_convert_to_training, convertToFeatures, sequences_sample, chunk_and_convert_ps_and_durations, extract_dictionaries_from_activities, convert_to_durations, signatureExtractionAll, all_greedy_activity_conversion, chunk_and_convert_ps
import sys
import glob
import numpy as np
import pickle
